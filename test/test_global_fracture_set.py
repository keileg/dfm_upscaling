...
class TestFractureSet(unittest.TestCase):
    ...
    def test_2d_branch_length_criterion(self):
        ...
        macro_network, micro_network = split_network(network, Criterion.smaller_than, branch_length=0.3)
    ...
    def test_2d_branch_length_or_isolated_branch_criterion(self):
        ...
        macro_network, micro_network = split_network(network, criteria, logical_op=np.logical_or, branch_length=0.2)
    ...
    def test_2d_branch_length_and_isolated_branch_criterion(self):
        ...
        criteria = [Criterion.smaller_than, Criterion.isolated]
        macro_network, micro_network = split_network(network, criteria, logical_op=np.logical_and, branch_length=0.35)
    ...
    def test_2d_branch_length_criterion_network_split(self):
        ...
        macro_network, micro_network = split_network(network, Criterion.smaller_than, branch_length=0.1)

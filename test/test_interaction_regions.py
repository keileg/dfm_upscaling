...
class TestRegions(unittest.TestCase):
    ...
    def test_tpfa_cart_grid_2d_interior_face(self):
        ...
        known_surfaces = np.array([[cells[0], fn_loc[0]],
                                   [cells[0], fn_loc[1]],
                                   [cells[1], fn_loc[0]],
                                   [cells[1], fn_loc[1]],
                                   ])
    ...
    def test_tpfa_cart_grid_3d_interior_face(self):
        ...
        known_surfaces = np.array([[cells[0], fn_loc[0], fn_loc[1]],
        ...
        known_edges = np.array([[cells[0], fn_loc[0], cells[1]],
    ...
    def test_mpfa_cart_grid_2d_interior_node(self):
        ...
        known_edges = np.array([[0, 11, 2],
                                [0, 1, 1],
                                [1, 12, 3],
                                [2, 4, 3]])
        
        known_surfaces = np.array([[0, 1],
                                   [1, 1],
                                   [0, 11],
                                   [2, 11],
                                   [2, 4],
    ...
    def test_mpfa_cart_grid_2d_boundary_node(self):
        ...
        known_surfaces = np.array([[0, 0],
                                   [0, 11],
                                   [2, 11],
                                   [2, 3]])        

        self.assertTrue(test_utils.compare_arrays(known_surfaces.T, reg.surfaces.T))
        self.assertTrue(test_utils.compare_arrays_varying_size(known_edges.T, reg.edges.T))
    ...
    def test_mpfa_cart_grid_3d_internal_node(self):
        ...
        known_surfaces = np.asarray([[0, 1, 4],
                                     [0, 1, 10],
                                     [1, 1, 4],
                                     [1, 1, 10],
                                     [0, 14, 4],
        ...
        self.assertTrue(test_utils.compare_arrays(known_surfaces.T, reg.surfaces.T, sort=False))
        self.assertTrue(test_utils.compare_arrays(known_edges.T, reg.edges.T, sort=False))
...
if __name__ == '__main__':
    TestRegions().test_mpfa_cart_grid_3d_boundary_node()
    unittest.main()